...
-- Includes Product Types, Categories, Brands, Products, Details, Promotions
-- =============================================================================
...
-- Di động categories (product_type_id = 1)
...
-- Truyền hình categories (product_type_id = 2)
INSERT INTO product_category (syntax, description, product_type_id, enabled) VALUES
...
-- Internet categories (product_type_id = 3)
INSERT INTO product_category (syntax, description, product_type_id, enabled) VALUES
...
-- Doanh nghiệp categories (product_type_id = 4)
INSERT INTO product_category (syntax, description, product_type_id, enabled) VALUES
